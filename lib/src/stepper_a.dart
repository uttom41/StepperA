...
abstract class _StepperAState<TWidget extends StepperA> extends State<TWidget>
    implements IMainPage {}

class _StepperAStateModel extends _StepperAState
    with TickerProviderStateMixin, MainStyle {
